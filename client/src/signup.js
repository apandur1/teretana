...
// function dajKarticu() {
//     let niz = dajNizClanarina()
//     let kartica = niz.at(niz.length - 1) + 1
//     return kartica
// }
...
class Signup extends React.Component {
  ...
  validate = () => {
    ...
    if (this.state.firstName === "") firstNameErr = "Molimo Vas unesite ime";
    if (this.state.lastName === "") lastNameErr = "Molimo Vas unesite prezime";
    if (this.state.email === "" || !this.state.email.includes("@"))
      emailErr = "Molimo Vas unesite validan mail";
    if (this.state.password === "") passwordErr = "Molimo Vas unesite sifru";
    if (this.state.confirm === "") confirmErr = "Molimo Vas potvrdite sifru";
    ...
    if (!this.state.spol) spolErr = "Molimo vas unesite spol";
  ...
  handleSubmit = (event) => {
    ...
    if (isValide) {
      ...
      let student = "Ne";
      if (this.state.student) student = "Da";
      const dodajUseraAjax = new XMLHttpRequest();
      dodajUseraAjax.onreadystatechange = function () {
        if (dodajUseraAjax.readyState === 4 && dodajUseraAjax.status === 200) {
          window.location.pathname = "/login";
        } else if (
          dodajUseraAjax.readyState === 4 &&
          dodajUseraAjax.status === 404
        )
          console.log("Greska");
      };
      dodajUseraAjax.open("POST", "http://127.0.0.1:3000/osoba");
      dodajUseraAjax.setRequestHeader(
        "Content-Type",
      ...
      dodajUseraAjax.send(
        JSON.stringify({
          ...
          sifra: this.state.password,
          student: student,
          spol: this.state.spol,
          trener: "Ne",
          ClanarinaId: this.state.kartica,
        })
      );
    } else {
          ...
          >
            <div className="row gx-5 justify-content-center">
              <div className="mb-3 form-group has-validation">
                <label htmlFor="InputFirstName2" className="form-label">
                  First name
                </label>
                <input
                  name="firstName"
                  ...
                  required
                ></input>
                <div className="greska">{this.state.firstNameErr}</div>
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                ></input>
                <div className="greska">{this.state.lastNameErr}</div>
              </div>
            </div>
            <div className="mb-3">
              ...
              <div className="greska">{this.state.emailErr}</div>
            </div>
            <div className="row gx-5 justify-content-center">
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                ></input>
                <div className="greska">{this.state.passwordErr}</div>
              </div>
              <div className="mb-3">
                ...
                <input
                  ...
                  required
                ></input>
                <div className="greska">{this.state.confirmErr}</div>
              </div>
            </div>
            <div className="mb-3">
              ...
              <input
                ...
                required
              ></input>
              <div className="greska">{this.state.studentErr}</div>
            </div>
            <div className="mb-3">
              <label htmlFor="InputSpol" className="form-label">
                Spol
              </label>
              <select
                name="spol"
