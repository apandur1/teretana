            ...
            <div className="row gx-5 justify-content-center">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Zato što uz pomoć naših vrhunskih trenera možete doći do tijela koje želite. Dobra atmosfera i intenzivni treninzi su zagarantovani.</p>
                    </div>
                </div>
